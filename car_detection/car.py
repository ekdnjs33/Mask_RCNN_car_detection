...
class CarDataset(utils.Dataset):
    ...
    def load_car(self, dataset_dir, subset):
        ...
        for a in annotations:
            ...
            names = [int(n['car']) for n in objects]
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        return mask.astype(np.bool), np.array(class_names, dtype=np.int32)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect car part datasets.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/home/dw/Deep-Learning/car_detection/car",
                        help='Directory of the car part dataset')
    parser.add_argument('--weights', required=True,
                        metavar="/home/dw/logs/weights.h5",
